...
var margin = { top: 150, right: 50, bottom: 350, left: 50 },
...
//Graph1
        ...
        // var colorSquare = totalGraph.data(d3.range(100))
        //           .enter()
        //           .append('rect')
        //           .attr('x', (d, i) => {
        //               var x0 = Math.floor(i / 100) % 10, x1 = Math.floor(i % 10);
...
d3.csv("globalproductiontrend.csv").then(function(data) {
    ...
    console.log("Year Quantity:",yearQuantity);
